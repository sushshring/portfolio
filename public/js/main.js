...
$('document').ready(function () {
  ...
  $.getJSON('./js/data.json', function(data) {
      data.experiences.forEach(function(loc) {
          var htmlString = "<div class=\"item container-fluid\">\n" +
              "                <div class=\"work-place row\">\n" +
              "                    <h3 class=\"place col-lg-4 col-md-12\">" + loc.companyName + "</h3>\n" +
              "                    <div class=\"location col-lg-4 col-md-12\"><i class=\"fa fa-map-marker\"></i>" + loc.location + "</div>\n" +
              "                </div>\n" +
              "                <div class=\"job-meta container-fluid\">\n" +
              "                    <div class=\"work-logo-left col-xl-12\">\n" +
              "                        <a href=\"" + loc.redirect + "\" target=\"_blank\">\n" +
              "                            <img src=\"" + loc.logo + "\" class=\"work-logo\">\n" +
              "                        </a>\n" +
              "                    </div>\n" +
              "                    <div class=\"title row\">\n" +
              "                        <p>"+loc.name+"</p>\n" +
              "                    </div>\n" +
              "                    <div class=\"time row\"> "+loc.duration + "</div>\n" +
              "                </div>\n" +
              "                <!--//job-meta-->\n" +
              "                <div class=\"job-desc\">\n" +
              "                    <ul>\n";
          loc.points.forEach(function (point) {
              htmlString = htmlString.concat("<li>" + point + "</li>");
          });
  ...
  $('.file_download').hide();
  $.ajax({
      url: "https://us-central1-portfolio-c7478.cloudfunctions.net/resume",
      success: function(data) {
        $('.file_download').attr('href', data);
        $('.file_download').show();
      },
